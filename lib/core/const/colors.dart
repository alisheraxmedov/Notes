...
class ColorClass {
  ...
  static const Color lightTeal = Color(0xFF80CBC4); // Light teal color
  static const Color lightTealAccent =
      Color(0xFFB2DFDB); // Even lighter teal accent
  ...
  static const Color settingsListLight = Color.fromARGB(255, 200, 255, 210); 
